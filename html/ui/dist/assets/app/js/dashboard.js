    ...
    return {
        init: function() {
            ...
            function() {
                ...
                if (0 != $("#m_chart_profit_share_1").length) {
                    var e = new Chartist.Pie("#m_chart_profit_share_1", {
                        series: [{
                            value: 32,
                            className: "custom",
                            meta: {
            ...
            function() {
                ...
                function() {
                    ...
                    function r(t, a, r) {
                        var o = "",
                            l = "";
                        a - t < 100 ? (o = "Today:", l = t.format("MMM D")) : "Yesterday" == r ? (o = "Yesterday:", l = t.format("MMM D")) : l = t.format("MMM D") + " - " + a.format("MMM D"), e.find(".m-subheader__daterange-date").html(l), e.find(".m-subheader__daterange-title").html(o)
                    }

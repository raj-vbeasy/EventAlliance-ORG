...
class ArtistsController extends ApiController
{
    ...
    private function _getChannelData($channel_id) {
        $channel_api_url = "https://www.googleapis.com/youtube/v3/channels?part=snippet,contentDetails,statistics&id=" . $channel_id . "&key=AIzaSyAiBTla0lc7ykFx-4GBewI993gTwHMDbT0";
